...
const handleConfirm = () => {
    ...
    <section className={styles.container}>
      ...
      <section className={styles.formContainer}>
        ...
        <section className={styles.rightColumn}>
          ...
          <SizeAndDimensions Width={Width} Height= {Height} Weight= {Weight}  setWidth={setWidth} setHeight={setHeight} setWeight={setWeight} />
          <DeliveryOptionSelector DelMethod={DelMethod} setDelMethod={setDelMethod} />
          <section className={styles.row}>
            <TypeOfArtSelector TypeOfArt={TypeOfArt} setTypeOfArt={setTypeOfArt}/>
            <EditTagsButton />
          </section>
  ...
  <section className={styles.popupOverlay}>
    <section className={styles.popup} role="dialog" aria-modal="true" aria-labelledby="popup-title">
      ...
      <section>
        ...
        <p><strong>Type of Art:</strong> {TypeOfArt}</p>
...
{missingFields.length > 0 && (
  <section className={styles.popupOverlay}>
    <section className={styles.popup} role="alertdialog" aria-modal="true" aria-labelledby="error-popup-title">
      <h2 id="error-popup-title">Please Fill Out All Required Fields</h2>
      <ul>
